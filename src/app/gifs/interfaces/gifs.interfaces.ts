// To parse this data:
//
//   import { Convert, SearchResposne } from "./file";
//
//   const searchResposne = Convert.toSearchResposne(json);
//
...
export class Convert {
  public static toSearchResposne(json: string): SearchResposne {
      return cast(JSON.parse(json), r("SearchResposne"));
  }

  public static searchResposneToJson(value: SearchResposne): string {
      return JSON.stringify(uncast(value, r("SearchResposne")), null, 2);
  }
}
